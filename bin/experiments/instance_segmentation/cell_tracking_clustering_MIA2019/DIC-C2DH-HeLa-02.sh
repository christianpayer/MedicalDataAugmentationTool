...
export PYTHONPATH=./
python bin/segment_and_track.py /media1/datasets/celltrackingchallenge/trainingdataset/DIC-C2DH-HeLa/02/ /media1/datasets/celltrackingchallenge/trainingdataset/DIC-C2DH-HeLa/gru_hdbscan/02_RES models/gru/DIC-C2DH-HeLa DIC-C2DH-HeLa
